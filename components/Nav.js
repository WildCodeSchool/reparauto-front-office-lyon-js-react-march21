  ...
  return (
    <div className=" shadow-lg py-6 px-8 bg-gradient-to-r from-yellow-400 to-red-500 text-white flex justify-around">
      ...
      <div className="flex">
        ...
        <div className="ml-8">
          <Link href="./Activities">Activitées</Link>
        </div>
        <div className="ml-8">
    ...
    return (
        ...
        {toggleMenu  && (
            <div className=" md:flex md:items-center ">
                <div className="ml-20 md:mx-4 text-gray-800"><Link href='./Appointments'>Rendez-vous</Link></div>
                <div className="ml-20 md:mx-4 text-gray-800"><Link href='./Activities'>Activités</Link></div>
